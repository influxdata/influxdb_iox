...
impl Scenario {
    ...
    pub async fn load_data(&self, influxdb2: &influxdb2_client::Client) -> Vec<String> {
        ...
        // |",
        // "+----------+---------+-------------------------------+----------------+",
        // "| server01 | us-west | 2021-04-12 15:52:03.480173    | 0.64
        // |", "| server01 |         | 2021-04-12 15:52:03.480173001 |
        // 27.99          |", "| server02 | us-west | 2021-04-12
        // 15:52:03.480173002 | 3.89           |", "| server01 | us-east
        // | 2021-04-12 15:52:03.480173003 | 1234567.891011 |",
        // "| server01 | us-west | 2021-04-12 15:52:03.480173004 | 0.000003
        // |",
        // "+----------+---------+-------------------------------+----------------+",
    }
