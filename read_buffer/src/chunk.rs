...
mod test {
    ...
    fn add_remove_tables() {
        ...
        assert_eq!(
            ...
            r#"read_buffer_column_bytes{db="mydb",encoding="BT_U32_VEC",log_data_type="i64"} 108"#,
            ...
            r#"read_buffer_column_raw_bytes{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="false"} 108"#,
            r#"read_buffer_column_raw_bytes{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="true"} 0"#,
            ...
            r#"read_buffer_column_total{db="mydb",encoding="BT_U32_VEC",log_data_type="i64"} 3"#,
            ...
            r#"read_buffer_column_values{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="false"} 9"#,
            r#"read_buffer_column_values{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="true"} 0"#,
        ...
        assert_eq!(
            ...
            vec![
                "# HELP read_buffer_column_bytes The number of bytes used by all columns in the Read Buffer",
                "# TYPE read_buffer_column_bytes gauge",
                r#"read_buffer_column_bytes{db="mydb",encoding="BT_U32_VEC",log_data_type="i64"} 0"#,
                ...
                r#"# HELP read_buffer_column_raw_bytes The number of bytes used by all columns if they were uncompressed in the Read Buffer"#,
                r#"# TYPE read_buffer_column_raw_bytes gauge"#,
                r#"read_buffer_column_raw_bytes{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="false"} 0"#,
                r#"read_buffer_column_raw_bytes{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="true"} 0"#,
                ...
                r#"# HELP read_buffer_column_total The number of columns within the Read Buffer"#,
                r#"# TYPE read_buffer_column_total gauge"#,
                r#"read_buffer_column_total{db="mydb",encoding="BT_U32_VEC",log_data_type="i64"} 0"#,
                ...
                r#"# HELP read_buffer_column_values The number of values within columns in the Read Buffer"#,
                r#"# TYPE read_buffer_column_values gauge"#,
                r#"read_buffer_column_values{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="false"} 0"#,
                r#"read_buffer_column_values{db="mydb",encoding="BT_U32_VEC",log_data_type="i64",null="true"} 0"#,
